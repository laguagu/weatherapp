...
function WeatherGrids() {
  ...
  const [weatherTemp, setWeatherTemp] = useState({celsius:"", feels_like: ""})
          ...
          <Paper elevation={3} sx={sharedPaperStyle} >
            ...
            <Grid container spacing={50}>
              ...
              <Grid item xs={6}>
                ...
                <Typography color="secondary" variant="h5" sx={{ marginTop: "15px" }}>
                  Lämpötila: 
                {weatherTemp.celsius > 0 ? " +":" -" }{weatherTemp.celsius+"°C"}
                <Typography>Feels Like {weatherTemp.feels_like +"°C"}</Typography>
                </Typography>
              </Grid>

              <Grid item xs={6}>
                <Typography color="primary" variant="h4" sx={{ marginTop: "15px" }}>{weatherInfo}</Typography>
                <img src={weatherIcon}/>
              </Grid>
